...
class CanvasIntegrationTests extends TestCase
{
    ...
    public function test_fetching_courses_and_enrollments(): void
    {
        ...
        $courses = $this->postJson('api/v1/actions/store-canvas-courses', $proc);
        ...
        $enrollments = $this->postJson('api/v1/actions/store-user-enrollments', $enroll);
    ...
    public function test_fetching_users_from_canvas(): void
    {
        ...
        $resp = $this->postJson('api/v1/actions/store-canvas-users', $req);
