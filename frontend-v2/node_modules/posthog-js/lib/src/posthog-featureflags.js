        ...
        this._instance._send_request({
            ...
            callback: function (response) {
                ...
                if (!_this._flagsCalled) {
                    ...
                    _this._instance._onRemoteConfig((_b = response.json) !== null && _b !== void 0 ? _b : {});
                }
                ...
                if ((_c = response.json) === null || _c === void 0 ? void 0 : _c.errorsWhileComputingFlags) {
                    flagErrors.push(exports.FeatureFlagError.ERRORS_WHILE_COMPUTING);
                }
                var isQuotaLimited = !!((_e = (_d = response.json) === null || _d === void 0 ? void 0 : _d.quotaLimited) === null || _e === void 0 ? void 0 : _e.includes(QuotaLimitedResource.FeatureFlags));
                if (isQuotaLimited) {
                    flagErrors.push(exports.FeatureFlagError.QUOTA_LIMITED);
                }
                (_f = _this._instance.persistence) === null || _f === void 0 ? void 0 : _f.register((_a = {},
                ...
                if (!data.disable_flags) {
                    _this.receivedFeatureFlags((_g = response.json) !== null && _g !== void 0 ? _g : {}, errorsLoading);
                }
                if (_this._additionalReloadRequested) {
