 ...
 */ const useSWRHandler = (_key, fetcher, config)=>{
    ...
    const isValidating = index_js.isUndefined(cached.isValidating) ? shouldDoInitialRevalidation : cached.isValidating;
    const isLoading = index_js.isUndefined(cached.isLoading) ? shouldDoInitialRevalidation : cached.isLoading;
