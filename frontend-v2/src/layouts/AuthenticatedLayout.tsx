...
export default function AuthenticatedLayout() {
    ...
    const isFullBleed =
        isProgramDetail || isResidentProfile || isResidentsPage || isClassDetail || isEventAttendance || isClassesPage || isDashboard || isProgramsList || isFacilities || isAdmins || isKnowledgeCenter || isContentViewer || isResidentPage;
    const fullBleedWrapperClass =
        isDashboard || isProgramsList || isFacilities || isAdmins || isProgramDetail || isResidentProfile || isResidentsPage || isClassDetail || isClassesPage || isKnowledgeCenter || isContentViewer || isResidentPage ? 'py-0' : 'py-4';
    ...
    const contentClass = `flex-1 ${isResidentKnowledgeCenter ? 'overflow-hidden' : 'overflow-y-auto'} overflow-x-hidden ${needsGrayBg ? 'min-h-full bg-[#E2E7EA]' : ''}`;
