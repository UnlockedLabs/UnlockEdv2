            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <div className="border border-gray-200 rounded-lg overflow-hidden">
                        <div className="grid grid-cols-7 bg-[#E2E7EA]">
                            {DAY_HEADERS.map((d) => (
                                <div
                                    key={d}
                            ...
                            <div key={wi} className="grid grid-cols-7">
                                {week.map((day) => (
                                    <button
                                        ...
                                        className={cn(
                                            'h-12 text-sm border-t border-r border-gray-100 last:border-r-0 flex items-center justify-center relative transition-colors',
                                            !day.isCurrentMonth &&
                                                'text-gray-300',
                                            day.isCurrentMonth &&
                                                !day.isClassDay &&
                                            ...
                                            day.isClassDay &&
                                                day.isCancelled &&
                                                'bg-gray-200 text-gray-400 line-through cursor-pointer hover:bg-gray-300',
                                            day.isToday &&
                    ...
                    {selectedDay && (
                        <div className="mt-4 p-4 bg-[#E2E7EA] rounded-lg">
