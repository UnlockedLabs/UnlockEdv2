...
export function BulkSessionsModal({
    ...
    const isCancelOther = cancelReason === String(CancelEventReason['Other (add note)']);
    ...
    const isApplyDisabled = (): boolean => {
        ...
        switch (actionType) {
            case 'cancel':
                return !cancelReason || (isCancelOther && !note.trim());
            case 'reschedule':
                return !newDate;
            case 'change-room':
            ...
            switch (actionType) {
                case 'cancel':
                    body = {
                        ...
                        is_cancelled: true,
                        reason: isCancelOther ? note.trim() : cancelReason
                    };
                    break;
                case 'reschedule':
                    body = {
                            ...
                            <div className="space-y-3">
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(v) => {
                                            setCancelReason(v);
                                            if (v !== String(CancelEventReason['Other (add note)'])) {
                                                setNote('');
                                            }
                                        }}
                                    >
                                ...
                                <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 flex items-start gap-2">
                                    ...
                                    <p className="text-sm text-amber-800">
                                        This will cancel {selectedDates.size}{' '}
                                        {selectedDates.size === 1 ? 'session' : 'sessions'}.
