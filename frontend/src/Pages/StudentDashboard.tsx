...
export default function StudentDashboard() {
      ...
      <div className="card card-compact bg-inner-background overflow-hidden relative">
        ...
        <div className="card-body gap-0.5">
          ...
          <p className="body-small line-clamp-4">
            Looking for more content to engage with? Browse courses offered at
            your facility.
          </p>
          <a
  ...
  const PopularCoursesCard = () => {
    return (
      ...
      >
        <div className="card-body gap-0.5">
          <h3 className="card-title text-sm">Popular Courses on UnlockEd</h3>
      ...
      <div className="px-8 py-4">
        ...
        <div className="mt-3 bg-base-teal p-6 card">
          ...
          >
            ...
            {data.recent_programs.length < 3 && <ExploreCourseCatalogCard />}
            {data.recent_programs.length < 2 && <PopularCoursesCard />}
          </div>
        </div>
