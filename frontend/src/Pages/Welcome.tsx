      ...
      <div className="flex justify-center p-10 bg-base-100">
        <div className="prose prose-lg prose-gray text-justify">
          ...
          <div className="flex flex-col">
            <img src={imgSrc} className="mb-2 w-full h-auto" loading="lazy" />
          ...
          <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
            <li>
              ...
              <div className="timeline-start md:text-end mb-10">
                <time className="font-mono italic text-secondary">1997</time>
            ...
            <li>
              ...
              <div className="timeline-end mb-10">
                <time className="font-mono italic text-secondary">2022</time>
                <div className="text-lg font-black text-neutral">
