            ...
            <div className="py-4 space-y-4">
                <ul className="space-y-2 text-sm text-gray-700">
                    ...
                    <li className="flex gap-2">
                        <span className="text-gray-400">&bull;</span>
                        <span>
                            The resident will not be able to log in or enroll in
                            new programs.
                        </span>
                    </li>
                    <li className="flex gap-2">
        ...
        >
            <div className="py-4 space-y-4">
                <p className="text-sm text-red-600 font-medium">
                    ...
                    resident will be permanently deleted.
                </p>
        ...
        >
                    ...
                    <>
                        <TonedPanel tone="orange">
                            <div className="font-medium text-orange-900 text-sm mb-1">
                                Transfer will unenroll resident from all classes
                            </div>
                            <div className="text-sm text-orange-800">
                                {resident.name_first} will be removed from all
                                active enrollments and must be re-enrolled at
                                the new facility.
                            </div>
                        </TonedPanel>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="space-y-1.5 text-sm text-gray-700">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>
                                        Account history and favorites will be
                                        preserved
                                    </span>
                                </div>
                                <div className="flex items-center gap-2">
            ...
            <DialogFooter>
                ...
                <Button
                    ...
                    disabled={
                        !transferFacilityId || !confirm.matches || loading
                    }
                    variant="brand"
                >
                    Transfer Resident
