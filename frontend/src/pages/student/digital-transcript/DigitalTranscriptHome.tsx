...
const ACHIEVEMENT_LOG_THUMBNAIL_SAMPLE: TranscriptEntry = {
    ...
    standoutMoment:
        'Instructors who explained things with patience and respect.',
    adviceToPeer: 'Use the tutor hours—you are not alone in the room.',
    oneSentence:
        'A program that helped me believe I could finish what I started.',
    q4Toggle: null,
    q4Text: '',
    q5BeforeTags: [],
    q5AfterTags: [],
...
export default function DigitalTranscriptHome() {
    ...
    const [deleteTarget, setDeleteTarget] = useState<TranscriptEntry | null>(
        null
    );
    ...
    const primaryCtaLabel =
        entries.length === 0 ? 'Start logging' : 'Add achievement';

    const cardTitle =
        entries.length === 0 && !hasDraft
            ? 'Start logging'
            : 'Build your Achievements Record';

    const deleteProgramName = getEntryDisplayTitle(
        deleteTarget?.programName,
        'Untitled'
    );
                            ...
                            <div className="min-w-0 flex-1">
                                <CardHeader className="space-y-1 pb-5">
                                    ...
                                    <CardDescription className="text-base leading-relaxed">
                                        {hasDraft ? (
                                            <>
                                                You have work in progress in the
                                                editor. Continue where you left
                                                off, or add a new program
                                                achievement.
                                            </>
                                        ) : entries.length === 0 ? (
                                            <>
                                                Open the editor and fill in what
                                                you did. Nothing appears on this
                                                list until you tap Done.
                                            </>
                                        ) : (
                                            <>
                                    ...
                                    <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-[inherit]">
                                        ...
                                        >
                                            <TranscriptResumePreview
                                                ...
                                                hideReadiness
                                                source={
                                                    ACHIEVEMENT_LOG_THUMBNAIL_SAMPLE
                                                }
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            <strong>{deleteProgramName}</strong> from your
