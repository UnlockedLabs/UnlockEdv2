...
const questionLabelClassName = 'text-base font-medium leading-snug text-foreground';
                ...
                return (
                    <div
                        ...
                        className={cn(
                            ...
                            checked ? learningRecordSelectedChoiceClassName : 'border-transparent'
                        )}
                    >
                        <Checkbox
                            id={optionId}
...
function renderStepFields(
    ...
    switch (stepIndex) {
        ...
        case 1:
            return (
                <>
                    <section className="space-y-3" aria-labelledby={`ach-q4-${id}`}>
                        <div>
                            <QuestionFieldHeader
                            ...
                            onValueChange={(v) => {
                                if (v === 'yes') {
                                    ...
                                    onChange({ q4Toggle: 'notReally', q4Text: '' });
                                }
                            }}
                    ...
                    <section className="space-y-4" aria-labelledby={`ach-q5-${id}`}>
                        <div>
                            <QuestionFieldHeader
                            ...
                            <TagCloud
                                ...
                                onChange={(q5BeforeTags) => onChange({ q5BeforeTags })}
                            />
                        </div>
                        <TagCloud
                            ...
                            onChange={(q5AfterTags) => onChange({ q5AfterTags })}
                        />
                        <ReflectionTextField
                            id={`ach-q5-free-${id}`}
        ...
        case 2:
            return (
                <>
                    <section className="space-y-3" aria-labelledby={`ach-confidence-${id}`}>
                        <div>
                            <QuestionFieldHeader
                                htmlFor={`ach-confidence-${id}`}
                                label={funnelStepFieldLabel('confidence')}
                                description={FUNNEL_FIELD_DESCRIPTIONS.confidence}
                            />
                    ...
                    <section aria-labelledby={`ach-q8-${id}`}>
                        ...
                        <ChecklistField
                            ...
                            onChange={(q8Selections) => onChange({ q8Selections })}
                            columns={2}
                        />
                    </section>
                    ...
                    <section aria-labelledby={`ach-q9-${id}`}>
                        ...
                        <ChecklistField
                            ...
                            onChange={(q9Selections) => onChange({ q9Selections })}
                        />
                    </section>
...
export function AchievementForm({
    ...
    return (
        <div data-slot="achievement-form" className="space-y-5 px-1 pt-2">
            ...
            {stepConfig ? (
                <div className="space-y-8">{renderStepFields(activeStep, entry, onChange, showSaveErrors)}</div>
            ) : null}
            ...
            <div className="flex gap-2 overflow-x-auto border-t border-border/60 pt-4">
                ...
                {!isLastStep && nextStep ? (
                    ...
                    <Button
                        type="button"
                        size={LEARNING_RECORD_BUTTON_SIZE}
                        className={cn('ml-auto', learningRecordPrimaryButtonClassName)}
                        onClick={onFinish}
                    >
                        Finish
                    </Button>
