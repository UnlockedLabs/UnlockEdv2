...
function getUtilizationRate(program: ProgramsOverviewTable): number {
    ...
    // Only seats in active classes count toward utilization, matching the
    // active-class-only capacity denominator (enrollments in scheduled/paused
    // classes would otherwise push this above 100%).
