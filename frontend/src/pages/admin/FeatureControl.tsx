                ...
                <div className="bg-background border border-border rounded-lg p-6">
                    <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                                Provides educational content, videos, and
                    ...
                    <div className="mt-4 bg-surface-hover rounded-md p-4">
                        <div className="flex items-start gap-2 mb-4 text-sm text-muted-foreground">
                            ...
                            <span>
                                Sub-features (only available when Knowledge
                                Center is enabled)
                            </span>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <SubFeatureRow
                                ...
                                enabled={isEnabled(
                                    FeatureAccess.UploadVideoAccess
                                )}
                                parentEnabled={kcEnabled}
                                onToggle={() =>
                                    requestToggle(
                    ...
                    <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-muted-foreground mt-1">
                                ...
                                achievements and generate a personal learning
                                record
                            </p>
                        </div>
                        <Switch
