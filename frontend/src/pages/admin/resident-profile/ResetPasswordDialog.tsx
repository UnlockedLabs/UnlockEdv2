...
export function ResetPasswordDialog({
    ...
    return (
        <FormModal
            ...
            title={isConfirmPhase ? 'Reset Password' : 'Password Reset'}
            description={
                isConfirmPhase
                    ? `Are you sure you want to reset ${user.name_first} ${user.name_last}'s password?`
                    : `New temporary password for ${user.name_first} ${user.name_last}`
            }
