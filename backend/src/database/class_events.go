...
outer:
	...
	for _, override := range event.Overrides { //adding the rescheduled ones to instances slice
		...
		instances = append(instances, rescheduledInstance)
	}
	slices.SortFunc(instances, func(a, b models.ClassEventInstance) int {
